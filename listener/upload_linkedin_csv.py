...
from common_configs.aws_storage import AwsStorage, STORAGE_USER_BUCKET, STORAGE_LINKEDIN_FOLDER
...
class IngestLinkedinCSV(Resource):
    def __init__(self):
        batch_size = 5
    ...
    def listen(self, ch, method, properties, body):
        ...
        redis_key_root = filename.replace(STORAGE_LINKEDIN_FOLDER + "/", "", 1)
