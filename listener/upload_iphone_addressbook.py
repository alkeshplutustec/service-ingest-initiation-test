...
from common_configs.aws_storage import AwsStorage, STORAGE_USER_BUCKET, STORAGE_IPHONE_ADDRESSBOOK_FOLDER
...
class IngestIPhoneAddressBook(Resource):
    def __init__(self):
        batch_size = 5
    ...
    def listen(self, ch, method, properties, body):
        ...
        if RABBIT_INGESTION_REPLICAS:
            ...
            routing_key = UPLOAD_IPHONE_ADDRESSBOOK_BATCH
